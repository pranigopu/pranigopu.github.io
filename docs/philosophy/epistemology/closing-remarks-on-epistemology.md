...
**NOTE**: _Do note confuse "contextual" with "subjective". "Contextual" only refers to a particular set of interrelated facts by which something can be understood and applied. "Subjective" on the other hand refers to treating a conscious unit (e.g. emotion, whim, intuition, untested notion, etc.) as valid "knowledge" apart from or even in contradiction to its relationship to the facts of reality._
