...
Dealing with emotions effectively requires grasping and validating the context of the premises underlying them (for the importance of contextual clarity, see: [_Contextual Clarity_ from **Epistemology**](https://pranigopu.github.io/philosophy/epistemology/contextual-clarity.html)). Hence, we shall look now into contextualising emotions, so as to recognise when our emotions are valid and when they are out of context and hence invalid.
