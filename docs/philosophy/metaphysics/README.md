...
Here, note that the identity of the change in any part of reality is inseparable from and derived from the identity of that part of reality. Any entity is necessarily within some part of reality. For convenience, let us pick some part of reality and call it X. Now, since the identities of the entities within X as well as the identities of their actions affect the identity of any change in X as a whole, it stands to reason that the actions of any entity within X are or can be affected by the actions of the other entities within X. Thus, the principle of causality means that given the same set of facts, nothing else can happen. In other words, the same entities in the same conditions can act only in a certain way and no other (i.e. their actions can have only a certain identity with respect to their own identities and no other).
