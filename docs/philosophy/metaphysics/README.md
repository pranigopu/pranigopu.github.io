...
To aware of something is to be aware and thereby affirm that it is, i.e. that it exists. To know something is to affirm that it is, i.e. that it exists. Hence, _awareness is knowledge_. Now, awareness is; if it not, nothing is affirmed or denied, i.e. nothing is said. To the extent that something is said, to that extent I affirm that awareness is, i.e. that I am aware. Hence, since awareness is knowledge, to the extent that I am aware, knowledge is, i.e. to the extent that I am aware, I know something and never nothing.
