...
**NOTE**: _There can be no capacity to create something from nothing, since for X create something from nothing is for X to cause something whose identity is detached in some way from the identity of X, which violates the principle of causality and thus the law of identity. Hence, such a capacity cannot be said to be a part of the identity of anything, not even a god (if such an entity were to exist at all)._
