...
**NOTE**: _Consciousness is the fundamental feature because though there are many necessary conditions for consciousness to exist (e.g. a brain, neural and chemical activity, etc.), none of them even combined are sufficient conditions for consciousness to exist. Hence, consciousness is a feature which is only necessitated by the particular integration of particular factors. By contrast, take the example of skin colour, which (in the context of normal lighting conditions) is necessitated by genetic factors. Here, the skin colour is an aspect of genetic factors, not an integration of something new._
