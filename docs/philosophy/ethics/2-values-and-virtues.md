...
**NOTE**: _By honesty, I do not mean simply "not lying" but rather "not misleading with the intention to mislead"; hence, hiding or omitting relevant details, intentionally equivocating or being ambiguous so as to mislead or confuse, projecting an intentionally misleading tone, etc. are all forms of dishonesty._
