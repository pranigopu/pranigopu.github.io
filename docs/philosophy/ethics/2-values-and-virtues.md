...
**NOTE**: _Honesty consists of the respect for truth and reality, which means honesty does not mean simply "not lying" but rather "not misleading or obfuscating the truth intentionally"; hence, hiding or omitting relevant details, intentionally equivocating or being ambiguous so as to mislead or confuse, projecting an intentionally misleading tone, etc. are all forms of dishonesty._
