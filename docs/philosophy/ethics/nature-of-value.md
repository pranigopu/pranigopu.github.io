...
To expand on the previous point, I posit that in some (and I do stress "some") contexts, difficult or even painful emotions such as fear, sadness, grief, etc. are the most life-affirming emotions possible precisely because they are what affirm our grasp of our values in these contexts and thereby orient us to their pursuit. If it is happiness and life lived to the fullest that you care about, then you have to accept — wholeheartedly — the capacity to suffer.
