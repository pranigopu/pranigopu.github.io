...
<details><summary><b>Necessary condition</b></summary>A necessary condition for a fact X is an actual or potential fact whose absence contradicts X, i.e. X can only be true if its necessary conditions are present.<br></details>
