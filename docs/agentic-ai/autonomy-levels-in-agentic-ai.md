...
> This document is based on the 5-level autonomy framework (L1–L5) and the conceptual foundation of agentic AI as given in (Feng et al, 2025): [*Levels of Autonomy for AI Agents*, **knightcolumbia.org/content**](https://knightcolumbia.org/content/levels-of-autonomy-for-ai-agents-1), including the hallmarks of autonomous operation, multi-step problem solving, and adaptability, as well as the problem-space categories of goal-driven planning, integration with diverse tools, and autonomous execution loops.

---

**AI-Use Disclaimer**: *This document has been generated by generative AI, but has been reviewed and edited by Prani Gopu. Details regarding the generation of this content have been provided below.*

> **GenAI Details**: [`doc=interpretability--desc=levels-of-autonomy-analysis`](https://pranigopu.github.io/agentic-ai/gen-ai-use-for-doc--autonomy-levels-in-agentic-ai.html)
...
- [2. AI Agency vs. Human Agency Matrix](#2-ai-agency-vs-human-agency-matrix)
  - [Level Placements with Justifications](#level-placements-with-justifications)
...
- [5. Interpretability and Accountability Considerations by Level](#5-interpretability-and-accountability-considerations-by-level)
  - [Framing](#framing)
