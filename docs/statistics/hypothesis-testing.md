...
# 0. Definitions
The following are defined and explained in [_Quantifying Probability_](https://pranigopu.github.io/statistics/quantifying-probability.html):
